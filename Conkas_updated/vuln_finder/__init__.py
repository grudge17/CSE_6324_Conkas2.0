...
from vuln_finder.tx_origin import tx_origin_analyse
from vuln_finder.costly_loops import costly_loops_analyse
...
available_modules = {
    ...
    'tx_origin': tx_origin_analyse,
    'costly_loops': costly_loops_analyse
}
